...
class RectangleFigure extends Figure {
    ...
    public RectangleFigure(int x,int y,int w,int h,Color c,boolean f) {
    super(x,y,w,h,c);
    flag = f;
...
class DrawModel extends Observable{
  ...
  public void createFigure(int x,int y) {
    Figure f = new RectangleFigure(x,y,0,0,currentColor,flag);
    fig.add(f);
    drawingFigure = f;
    setChanged();
    notifyObservers();
...
// update が呼び出される．
class ViewPanel extends JPanel implements Observer,KeyListener {
